    ...
    def self.default_links
      [
        ...
        },
        {
          ...
          :text => I18n.t('#help_dialog.search_the_SmartLMS_guides', 'Search the SmartLMS Guides'),
          :subtext => I18n.t('#help_dialog.SmartLMS_help_sub', 'Find answers to common questions'),
          :url => 'http://guides.instructure.com'
        },
        {
          :available_to => ['user', 'student', 'teacher', 'admin'],
          :text => I18n.t('#help_dialog.report_problem', 'Report a Problem'),
          :subtext => I18n.t('#help_dialog.report_problem_sub', 'If SmartLMS misbehaves, tell us about it'),
          :url => '#create_ticket'
        }
      ]
    end
