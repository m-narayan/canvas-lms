(function() {
  require(['jquery', 'compiled/jquery/fixDialogButtons', 'jquery.disableWhileLoading', 'helpers/jquery.simulate'], function($, elementToggler) {
    ...
    return test("enter key does not duplicate submissions if fixDialogButtons invoked more than once", function() {
      var $dialog, submitCount;
